	...
	if( $('.slideshow').length > 0 ) {
		$.supersized({
			...
			slides:  	[				// Slideshow Images
							{image : 'assets/img/sliders/bigstock-hipster-style-office-table-118717157.jpg', title : '<div class="hero-text"><h2 class="hero-heading">Thuy Nguyen</h2><p>Front-End Developer</p></div>', thumb : '', url : ''},
							// {image : 'assets/img/sliders/slider2.jpg', title : '<div class="hero-text"><h2 class="hero-heading">Front-End Development</h2><p>Creating with Javascript, HTML & CSS </p></div>', thumb : '', url : ''},
							// {image : 'assets/img/sliders/slider3.jpg', title : '<div class="hero-text"><h2 class="hero-heading">Brand Marketing</h2><p>People. Culture. Story.</p></div>', thumb : '', url : ''}  
							// {image : 'assets/img/sliders/slider3.jpg', title : '<div class="hero-text"><h2 class="hero-heading">Let Talk!</h2><p>Let get coffee.</p></div>', thumb : '', url : ''}  
						],
		});
